...
- **Substance-over-form leeway.** Per the core principle, when the paper is a non-modal archetype (irrelevance / impossibility / calibration / existence / pure characterization / tools-or-methodology / kernel-primitive asset-pricing / mechanism-design corner-as-optimal / welfare-benchmark redefinition), adapt your reads accordingly — do not flag the absence of comparative statics, interior optima, or directional predictions as a conceptual gap when the archetype does not produce them. Probe whether the archetype-appropriate content (boundary conditions, identifying assumptions, characterization completeness, kernel restrictions, optimal-design corner, benchmark-selection argument) is correct and complete. Use sparingly; never invoke leeway to wave through actually-broken economic content.
