...
| **PUZZLE-CANDIDATE** | Literature shows a SIGN REVERSAL or an ORDER-OF-MAGNITUDE discrepancy vs. what the theory predicts | Launch puzzle-triager immediately (see Step 5) — gap-scout's lit-check is the contradicting evidence. Do not wait for Stage 3a/3c. |
