...
| Parsimony | 10% | Tractable GE with one key friction, every assumption load-bearing = 100, one or two robustness extensions = 80, multiple non-load-bearing extensions = 60, kitchen-sink DSGE = 20. Assumptions added to address audits but not used in main proof count against. |
